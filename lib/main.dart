...
Future<void> main() async {
  ...
  // استقبال روابط الإحالة (Deep / Deferred Deep Links) وتهيئة ChottuLink SDK
  // تُدار بالكامل في ReferralLinkManager — يبدأ من _MyAppState.initState.
...
class MyApp extends StatefulWidget {
  ...
  /// حالة توجيه روابط الإحالة/التفاصيل انتقلت بالكامل إلى
  /// [ReferralLinkManager] — تقرأها شاشة السبلاش من هناك مباشرة:
  ///   ReferralLinkManager.instance.pendingDetailsEstateId
  ///   ReferralLinkManager.instance.pendingReferralSignUp
  ///   ReferralLinkManager.instance.referralLinkDetected
  ///   ReferralLinkManager.instance.splashHasRouted
