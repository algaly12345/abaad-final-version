...
class AppConstants {
  ...
  static const String BASE_URL = 'http://10.135.230.108';

  // static const String BASE_URL = 'https://baad.arabengksa.com';
  static const String LAND_SERVICE_URL =
      'https://geoportal-st.gasgi.gov.sa/hosting/rest/services/Hosted/MOT_Layer04_View/FeatureServer/0/query?where=1%3D1&outFields=&outSR=4326&f=json';
  ...
  static const String PROVIDER_OFFER_SETUP_DATA_URI =
      '/api/v1/provider-subscriptions/offer-setup-data';
  static const String PROVIDER_CALCULATE_PRICE_URI =
  ...
  static const String DISTRICT_BY_CITY =
      '/api/v1/zones/get-districts-by-cities/';
  static const String CITIES_BY_REGIONS =
      '/api/v1/zones/get-cities-by-regions/';
  ...
  static const String check_request_status =
      '/api/v1/customer/check-request-status';
  static const googleMapKey = 'AIzaSyAwM15LYUky7qqVuXdBQc9zavA39y487jQ';
