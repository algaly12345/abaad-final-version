                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // المنتج العقاري" بقي هنا في الفلاتر المتقدمة — مطابقةً
                      // لموضعه في التطبيق المرجعي.

                      // نوع المنتج العقاري — الفئات هنا مأخوذة من جدول الفئات
                      // العام للتطبيق (filtersData.categories)، وقد تضم أحيانًا
                      // أنواعًا غير عقارية؛ لكن العميل طلب صراحةً تسميته "نوع
                      // المنتج العقاري" فاعتُمد المفتاح provider_type بهذه
                      // القيمة. بانتظار وصول filtersData يُعرض هيكل تحميل بنفس
                      // أبعاد الشبكة الفعلية بدل اختفاء القسم بالكامل، كي لا
                      // تقفز الأبعاد ولا يبدو القسم كأنه غير موجود أصلًا.
