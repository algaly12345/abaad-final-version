...
class _ServiceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // قبل إضافة هذا الحقل (راجع نفس المنطق في service_details_screen.dart).
...
class _ServiceActionButtons extends StatelessWidget {
  ...
  // احتياطياً) وتصنيفه — يحدّدان أي من زرّي الاتصال/واتساب يظهر.
  final String phone;
  ...
  Widget build(BuildContext context) {
    final zone = _mappableZone;
    final primary = Theme.of(context).primaryColor;
    final showCall = contactType != 'whatsapp';
    final showWhatsapp = contactType != 'call';
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        if (showCall)
