...
import 'package:abaad_flutter/view/screen/home/home_screen.dart' hide CategoryController;
          ...
          return BottomAppBar(
            ...
            child: Padding(
              ...
              child: Row(children: [
                ...
                BottomNavItem(iconData: Images.request,name: "request".tr, isSelected: _pageIndex == 2, onTap: () => _setPage(2)),
